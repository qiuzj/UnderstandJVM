...
public class CountApplet extends Applet implements ActionListener {
	...
	public void init() {
		...
		importer = new ObjectImporter(this); // here
		commonInit();
	}

	/*
	 * call this method instead of init() if this program is not run as an
	 * applet.
	 */
	public void applicationInit() {
		paramButton = "OK";
		paramName = "counter";
		Viewer cl = (Viewer) getClass().getClassLoader(); // here
		importer = new ObjectImporter(cl.getServer(), cl.getPort()); // here
		commonInit();
	}
	...
	public void start() {
		try {
			counter = (Counter) importer.lookupObject(paramName); // here
